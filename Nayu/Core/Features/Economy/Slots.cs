    ...
    public class Slot
    {
        ...
        public static readonly List<SlotPiece> PossibleSlotPieces = new List<SlotPiece>
        {
          // new SlotPiece("emojiString", minSpawnCount, spawnRate, payoutRate); 
             new SlotPiece(":pineapple:",   1, 2, 10  ),
        ...
        // Returns the amount of Taiyakis you win with the current pointers of the Cylinders if you bet <amount> of Taiyakis
        public Tuple<uint, string> GetPayoutAndFlavourText(uint amount)
        {
            ...
            if (moneyGain > amount)
                ...
                message += "you got your Taiyakis back... But sadly didn't win anything :/";
            else if (moneyGain > 0)
                message += $"at least you got some of your Taiyakis back... Just **{moneyGain}** sadly :C";
            else
