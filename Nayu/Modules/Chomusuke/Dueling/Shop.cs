...
namespace Nayu.Modules.Chomusuke.Dueling
{
    public class Shop : NayuModule
    {
        ...
        public async Task DuelsInventory([Remainder] string arg = "")
        {
            ...
            if (account.Items.ContainsKey("Strength Potion") || account.Items.ContainsKey("Speed Potion") ||
                account.Items.ContainsKey("Debuff Potion") ||
                account.Items.ContainsKey("Equalizer Potion")) potions = $"";
            if (account.Weapon != null) weapon = $"";
            if (account.Items.ContainsKey("Metallic Acid") || account.Items.ContainsKey("Weapon Liquifier") ||
                account.Items.ContainsKey("Basic Treatment") || account.Items.ContainsKey("Divine Shield") ||
                account.Items.ContainsKey("Vile Of Poison")) items = $"";
            if (account.Items.ContainsKey("Strength Potion"))
                potions += $"\nStrength Potion **x {account.Items["Strength Potion"]}**";
            if (account.Items.ContainsKey("Speed Potion"))
                potions += $"\nSpeed Potion **x {account.Items["Speed Potion"]}**";
            if (account.Items.ContainsKey("Debuff Potion"))
                potions += $"\nDebuff Potion **x {account.Items["Debuff Potion"]}**";
            if (account.Items.ContainsKey("Equalizer Potion"))
            ...
            if (account.Items.ContainsKey("Metallic Acid"))
                items += $"\nMetallic Acid **x {account.Items["Metallic Acid"]}**";
            if (account.Items.ContainsKey("Weapon Liquifier"))
                items += $"\nWeapon Liquifier **x {account.Items["Weapon Liquifier"]}**";
            if (account.Items.ContainsKey("Basic Treatment"))
                items += $"\nBasic Treatment **x {account.Items["Basic Treatment"]}**";
            if (account.Items.ContainsKey("Divine Shield"))
                items += $"\nDivine Shield **x {account.Items["Divine Shield"]}**";
            if (account.Items.ContainsKey("Vile Of Poison"))
