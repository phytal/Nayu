...
namespace Nayu.Modules.API.Overwatch
{
    public class HeroStats : NayuModule
    {
        ...
        [Alias("owhs")]
        [Remarks("n!owherostats <hero> <Your Battle.net username and id> <platform (pc/xbl/psn)> <region (us/eu etc.)> Ex: n!owherostats dVa Phytal-1427 pc us")]
        [Cooldown(10)]
        public async Task GetOwHeroStats(string hero, string username, string platform, string region)
        {
            try
            {
                ...
                if (hero == "baptiste")
                {
                    string qpAmplificationMatrixAssists = dataObject.quickPlayStats.careerStats[hero].heroSpecific.amplificationMatrixAssists.ToString();
                    string qpAmplificationMatrixAssistsPer10Min = dataObject.quickPlayStats.careerStats[hero].heroSpecific.amplificationMatrixAssistsAvgPer10Min.ToString();
                    string qpAmplificationMatrixAssistsBestIG = dataObject.quickPlayStats.careerStats[hero].heroSpecific.amplificationMatrixAssistsBestInGame.ToString();
                    string qpAmplificationMatrixCasts = dataObject.quickPlayStats.careerStats[hero].heroSpecific.amplificationMatrixCasts.ToString();
                    string qpAmplificationMatrixCastsAvg10Min = dataObject.quickPlayStats.careerStats[hero].heroSpecific.amplificationMatrixCastsAvgPer10Min.ToString();
                    string qpAmplificationMatrixCastsMostIG = dataObject.quickPlayStats.careerStats[hero].heroSpecific.amplificationMatrixCastsMostInGame.ToString();
                    string qpDamageAmplified = dataObject.quickPlayStats.careerStats[hero].heroSpecific.damageAmplified.ToString();
                    string qpDamageAmplifiedAvg10Min = dataObject.quickPlayStats.careerStats[hero].heroSpecific.damageAmplifiedAvgPer10Min.ToString();
                    ...
                    string qpHealingAccuracy = dataObject.quickPlayStats.careerStats[hero].heroSpecific.healingAccuracy.ToString();
                    string qpHealingAccuracyBestInGame = dataObject.quickPlayStats.careerStats[hero].heroSpecific.healingAccuracyBestInGame.ToString();
                    string qpHealingAmplified = dataObject.quickPlayStats.careerStats[hero].heroSpecific.healingAmplified.ToString();
                    string qpHealingAmplifiedAvg10Min = dataObject.quickPlayStats.careerStats[hero].heroSpecific.healingAmplifiedAvgPer10Min.ToString();
                    string qpHealingAmplifiedMostInGame = dataObject.quickPlayStats.careerStats[hero].heroSpecific.healingAmplifiedMostInGame.ToString();
                    string qpImmortalityFieldDeathsPrevented = dataObject.quickPlayStats.careerStats[hero].heroSpecific.immortalityFieldDeathsPrevented.ToString();
                    string qpImmortalityFieldDeathsPreventedAvg10Min = dataObject.quickPlayStats.careerStats[hero].heroSpecific.immortalityFieldDeathsPreventedAvgPer10Min.ToString();
                    string qpImmortalityFieldDeathsPreventedMostInGame = dataObject.quickPlayStats.careerStats[hero].heroSpecific.immortalityFieldDeathsPreventedMostInGame.ToString();
                    string qpSecondaryFireAccuracy = dataObject.quickPlayStats.careerStats[hero].heroSpecific.secondaryFireAccuracy.ToString();
                    string qpSelfHealing = dataObject.quickPlayStats.careerStats[hero].heroSpecific.unscopedAccuracyBestInGame.ToString();
                    ...
                    string compAmplificationMatrixAssists = dataObject.competitiveStats.careerStats[hero].heroSpecific.amplificationMatrixAssists.ToString();
                    string compAmplificationMatrixAssistsPer10Min = dataObject.competitiveStats.careerStats[hero].heroSpecific.amplificationMatrixAssistsAvgPer10Min.ToString();
                    string compAmplificationMatrixAssistsBestIG = dataObject.competitiveStats.careerStats[hero].heroSpecific.amplificationMatrixAssistsBestInGame.ToString();
                    string compAmplificationMatrixCasts = dataObject.competitiveStats.careerStats[hero].heroSpecific.amplificationMatrixCasts.ToString();
                    string compAmplificationMatrixCastsAvg10Min = dataObject.competitiveStats.careerStats[hero].heroSpecific.amplificationMatrixCastsAvgPer10Min.ToString();
                    string compAmplificationMatrixCastsMostIG = dataObject.competitiveStats.careerStats[hero].heroSpecific.amplificationMatrixCastsMostInGame.ToString();
                    string compDamageAmplified = dataObject.competitiveStats.careerStats[hero].heroSpecific.damageAmplified.ToString();
                    string compDamageAmplifiedAvg10Min = dataObject.competitiveStats.careerStats[hero].heroSpecific.damageAmplifiedAvgPer10Min.ToString();
                    ...
                    string compHealingAccuracy = dataObject.competitiveStats.careerStats[hero].heroSpecific.healingAccuracy.ToString();
                    string compHealingAccuracyBestInGame = dataObject.competitiveStats.careerStats[hero].heroSpecific.healingAccuracyBestInGame.ToString();
                    string compHealingAmplified = dataObject.competitiveStats.careerStats[hero].heroSpecific.healingAmplified.ToString();
                    string compHealingAmplifiedAvg10Min = dataObject.competitiveStats.careerStats[hero].heroSpecific.healingAmplifiedAvgPer10Min.ToString();
                    string compHealingAmplifiedMostInGame = dataObject.competitiveStats.careerStats[hero].heroSpecific.healingAmplifiedMostInGame.ToString();
                    string compImmortalityFieldDeathsPrevented = dataObject.competitiveStats.careerStats[hero].heroSpecific.immortalityFieldDeathsPrevented.ToString();
                    string compImmortalityFieldDeathsPreventedAvg10Min = dataObject.competitiveStats.careerStats[hero].heroSpecific.immortalityFieldDeathsPreventedAvgPer10Min.ToString();
                    string compImmortalityFieldDeathsPreventedMostInGame = dataObject.competitiveStats.careerStats[hero].heroSpecific.immortalityFieldDeathsPreventedMostInGame.ToString();
                    string compSecondaryFireAccuracy = dataObject.competitiveStats.careerStats[hero].heroSpecific.secondaryFireAccuracy.ToString();
                    string compSelfHealing = dataObject.competitiveStats.careerStats[hero].heroSpecific.unscopedAccuracyBestInGame.ToString();
                    ...
                    string qpAssists = $"Defensive Assists: **{QpdefensiveAssists}**\nAverage Defensive Assists per 10 Minutes: **{QpdefensiveAssistsAvgPer10Min}**\nMost Defensive Assists In Game: **{QpdefensiveAssistsMostInGame}**\nHealing Done: **{QphealingDone}**\nAverage Healing Done per 10 Minutes: **{QphealingDoneAvgPer10Min}**\nMost Healing Done In Game: **{QphealingDoneMostInGame}**\nOffensive Assists: **{QpoffensiveAssists}**\nAverage Offensive Assists per 10 Minutes: **{QpoffensiveAssistsAvgPer10Min}**\nMost Offensive Assists In Game: **{QpoffensiveAssistsMostInGame}**";
                    string compAssists = $"Defensive Assists: **{CompdefensiveAssists}**\nAverage Defensive Assists per 10 Minutes: **{CompdefensiveAssistsAvgPer10Min}**\nMost Defensive Assists In Game: **{CompdefensiveAssistsMostInGame}**\nHealing Done: **{ComphealingDone}**\nAverage Healing Done per 10 Minutes: **{ComphealingDoneAvgPer10Min}**\nMost Healing Done In Game: **{ComphealingDoneMostInGame}**\nOffensive Assists: **{CompoffensiveAssists}**\nAverage Offensive Assists per 10 Minutes: **{CompoffensiveAssistsAvgPer10Min}**\nMost Offensive Assists In Game: **{CompoffensiveAssistsMostInGame}**";
                    string qpHeroSpecific = $"Amplification Matrix Assists: **{qpAmplificationMatrixAssists}**\nAverage Amplification Matrix Assists per 10 Minutes: **{qpAmplificationMatrixAssistsPer10Min}**\nMost Amplification Matrix Assists In Game: **{qpAmplificationMatrixAssistsBestIG}**\nAmplification Matrix Casts: **{qpAmplificationMatrixCasts}**\nAverage Amplification Matrix Casts per 10 Minutes: **{qpAmplificationMatrixCastsAvg10Min}**\nMost Amplification Matrix Casts In Game: **{qpAmplificationMatrixCastsMostIG}**\nDamage Amplified: **{qpDamageAmplified}**\nAverage Damage Amplified per 10 Minutes: **{qpDamageAmplifiedAvg10Min}**\nMost Damage Amplified In Game: **{qpDamageAmplifiedMostInGame}**\nHealing Accuracy: **{qpHealingAccuracy}**\nBest Healing Accuracy In Game: **{qpHealingAccuracyBestInGame}**\nHealing Amplified: **{qpHealingAmplified}**\nAverage Healing Amplified per 10 Minutes: **{qpHealingAmplifiedAvg10Min}**\nMost Healing Amplified In Game: **{qpHealingAmplifiedMostInGame}**\nImmortality Field Deaths Prevented: **{qpImmortalityFieldDeathsPrevented}**\nAverage Immortality Field Deaths Prevented per 10 Minutes: **{qpImmortalityFieldDeathsPreventedAvg10Min}**\nMost Immortality Field Deaths Prevented In Game: **{qpImmortalityFieldDeathsPreventedMostInGame}**\nSecondary Fire Accuracy: **{qpSecondaryFireAccuracy}**\nSelf Healing: **{qpSelfHealing}**\nAverage Self Healing per 10 Minutes: **{qpSelfHealingAvgPer10Min}**\nMost Self Healing In Game: **{qpSelfHealingMostInGame}**";
                    string compHeroSpecific = $"Amplification Matrix Assists: **{compAmplificationMatrixAssists}**\nAverage Amplification Matrix Assists per 10 Minutes: **{compAmplificationMatrixAssistsPer10Min}**\nMost Amplification Matrix Assists In Game: **{compAmplificationMatrixAssistsBestIG}**\nAmplification Matrix Casts: **{compAmplificationMatrixCasts}**\nAverage Amplification Matrix Casts per 10 Minutes: **{compAmplificationMatrixCastsAvg10Min}**\nMost Amplification Matrix Casts In Game: **{compAmplificationMatrixCastsMostIG}**\nDamage Amplified: **{compDamageAmplified}**\nAverage Damage Amplified per 10 Minutes: **{compDamageAmplifiedAvg10Min}**\nMost Damage Amplified In Game: **{compDamageAmplifiedMostInGame}**\nHealing Accuracy: **{compHealingAccuracy}**\nBest Healing Accuracy In Game: **{compHealingAccuracyBestInGame}**\nHealing Amplified: **{compHealingAmplified}**\nAverage Healing Amplified per 10 Minutes: **{compHealingAmplifiedAvg10Min}**\nMost Healing Amplified In Game: **{compHealingAmplifiedMostInGame}**\nImmortality Field Deaths Prevented: **{compImmortalityFieldDeathsPrevented}**\nAverage Immortality Field Deaths Prevented per 10 Minutes: **{compImmortalityFieldDeathsPreventedAvg10Min}**\nMost Immortality Field Deaths Prevented In Game: **{compImmortalityFieldDeathsPreventedMostInGame}**\nSecondary Fire Accuracy: **{compSecondaryFireAccuracy}**\nSelf Healing: **{compSelfHealing}**\nAverage Self Healing per 10 Minutes: **{compSelfHealingAvgPer10Min}**\nMost Self Healing In Game: **{compSelfHealingMostInGame}**";
                    PaginatedMessage pages = new PaginatedMessage { Pages = new[] { compAvg, compBest, compTotal, compMisc, qpAvg, qpBest, qpTotal, qpMisc, qpAssists, compAssists, qpHeroSpecific, compHeroSpecific }, Content = $"{username}'s Hero Stats for {hero}", Color = Color.Blue, Title = new[] { "Competitive Averages", "Competitive Best", "Competitive Totals", "Competitive Miscellaneous", "Quickplay Averages", "Quickplay Best", "Quickplay Totals", "Quickplay Miscellaneous", "Quickplay Assists", "Competitive Assists", "Quickplay Hero Specific", "Competitive Hero Specific" } };
                    await PagedReplyAsync(pages);
                }
                if (hero == "bastion")
        ...
        [Alias("owhsqp")]
        [Remarks("n!owherostatsqp <hero> <Your Battle.net username and id> <platform (pc/xbl/psn)> <region (us/eu etc.)> Ex: n!owherostatsqp dVa Phytal-1427 pc us")]
        [Cooldown(10)]
        public async Task GetOwHeroStatsQP(string hero, string username, string platform, string region)
        {
            try
            {
                ...
                if (hero == "baptiste")
                {
                    ...
                    string qpAssists = $"Defensive Assists: **{QpdefensiveAssists}**\nAverage Defensive Assists per 10 Minutes: **{QpdefensiveAssistsAvgPer10Min}**\nMost Defensive Assists In Game: **{QpdefensiveAssistsMostInGame}**\nHealing Done: **{QphealingDone}**\nAverage Healing Done per 10 Minutes: **{QphealingDoneAvgPer10Min}**\nMost Healing Done In Game: **{QphealingDoneMostInGame}**\nOffensive Assists: **{QpoffensiveAssists}**\nAverage Offensive Assists per 10 Minutes: **{QpoffensiveAssistsAvgPer10Min}**\nMost Offensive Assists In Game: **{QpoffensiveAssistsMostInGame}**";
                    string qpHeroSpecific = $"Amplification Matrix Assists: **{qpAmplificationMatrixAssists}**\nAverage Amplification Matrix Assists per 10 Minutes: **{qpAmplificationMatrixAssistsPer10Min}**\nMost Amplification Matrix Assists In Game: **{qpAmplificationMatrixAssistsBestIG}**\nAmplification Matrix Casts: **{qpAmplificationMatrixCasts}**\nAverage Amplification Matrix Casts per 10 Minutes: **{qpAmplificationMatrixCastsAvg10Min}**\nMost Amplification Matrix Casts In Game: **{qpAmplificationMatrixCastsMostIG}**\nDamage Amplified: **{qpDamageAmplified}**\nAverage Damage Amplified per 10 Minutes: **{qpDamageAmplifiedAvg10Min}**\nMost Damage Amplified In Game: **{qpDamageAmplifiedMostInGame}**\nHealing Accuracy: **{qpHealingAccuracy}**\nBest Healing Accuracy In Game: **{qpHealingAccuracyBestInGame}**\nHealing Amplified: **{qpHealingAmplified}**\nAverage Healing Amplified per 10 Minutes: **{qpHealingAmplifiedAvg10Min}**\nMost Healing Amplified In Game: **{qpHealingAmplifiedMostInGame}**\nImmortality Field Deaths Prevented: **{qpImmortalityFieldDeathsPrevented}**\nAverage Immortality Field Deaths Prevented per 10 Minutes: **{qpImmortalityFieldDeathsPreventedAvg10Min}**\nMost Immortality Field Deaths Prevented In Game: **{qpImmortalityFieldDeathsPreventedMostInGame}**\nSecondary Fire Accuracy: **{qpSecondaryFireAccuracy}**\nSelf Healing: **{qpSelfHealing}**\nAverage Self Healing per 10 Minutes: **{qpSelfHealingAvgPer10Min}**\nMost Self Healing In Game: **{qpSelfHealingMostInGame}**";
                    PaginatedMessage pages = new PaginatedMessage { Pages = new[] { qpAvg, qpBest, qpTotal, qpMisc, qpAssists, qpHeroSpecific }, Content = $"{username}'s Hero Stats for {hero}", Color = Color.Blue, Title = new[] { "Averages", "Best", "Totals", "Miscellaneous", "Assists", "Hero Specific" } };
                    await PagedReplyAsync(pages);
                }
                if (hero == "bastion")
                {
        ...
        [Alias("owhsc")]
        [Remarks("n!owherostatscomp <hero> <Your Battle.net username and id> <platform (pc/xbl/psn)> <region (us/eu etc.)> Ex: n!owherostatscomp dVa Phytal-1427 pc us")]
        [Cooldown(10)]
        public async Task GetOwHeroStatsComp(string hero, string username, string platform, string region)
        {
            try
            {
                ...
                if (hero == "baptiste")
                {
                    ...
                    string compAssists = $"Defensive Assists: **{CompdefensiveAssists}**\nAverage Defensive Assists per 10 Minutes: **{CompdefensiveAssistsAvgPer10Min}**\nMost Defensive Assists In Game: **{CompdefensiveAssistsMostInGame}**\nHealing Done: **{ComphealingDone}**\nAverage Healing Done per 10 Minutes: **{ComphealingDoneAvgPer10Min}**\nMost Healing Done In Game: **{ComphealingDoneMostInGame}**\nOffensive Assists: **{CompoffensiveAssists}**\nAverage Offensive Assists per 10 Minutes: **{CompoffensiveAssistsAvgPer10Min}**\nMost Offensive Assists In Game: **{CompoffensiveAssistsMostInGame}**";
                    string compHeroSpecific = $"Amplification Matrix Assists: **{compAmplificationMatrixAssists}**\nAverage Amplification Matrix Assists per 10 Minutes: **{compAmplificationMatrixAssistsPer10Min}**\nMost Amplification Matrix Assists In Game: **{compAmplificationMatrixAssistsBestIG}**\nAmplification Matrix Casts: **{compAmplificationMatrixCasts}**\nAverage Amplification Matrix Casts per 10 Minutes: **{compAmplificationMatrixCastsAvg10Min}**\nMost Amplification Matrix Casts In Game: **{compAmplificationMatrixCastsMostIG}**\nDamage Amplified: **{compDamageAmplified}**\nAverage Damage Amplified per 10 Minutes: **{compDamageAmplifiedAvg10Min}**\nMost Damage Amplified In Game: **{compDamageAmplifiedMostInGame}**\nHealing Accuracy: **{compHealingAccuracy}**\nBest Healing Accuracy In Game: **{compHealingAccuracyBestInGame}**\nHealing Amplified: **{compHealingAmplified}**\nAverage Healing Amplified per 10 Minutes: **{compHealingAmplifiedAvg10Min}**\nMost Healing Amplified In Game: **{compHealingAmplifiedMostInGame}**\nImmortality Field Deaths Prevented: **{compImmortalityFieldDeathsPrevented}**\nAverage Immortality Field Deaths Prevented per 10 Minutes: **{compImmortalityFieldDeathsPreventedAvg10Min}**\nMost Immortality Field Deaths Prevented In Game: **{compImmortalityFieldDeathsPreventedMostInGame}**\nSecondary Fire Accuracy: **{compSecondaryFireAccuracy}**\nSelf Healing: **{compSelfHealing}**\nAverage Self Healing per 10 Minutes: **{compSelfHealingAvgPer10Min}**\nMost Self Healing In Game: **{compSelfHealingMostInGame}**";
                    PaginatedMessage pages = new PaginatedMessage { Pages = new[] { compAvg, compBest, compTotal, compMisc, compAssists, compHeroSpecific }, Content = $"{username}'s Hero Stats for {hero}", Color = Color.Blue, Title = new[] { "Averages", "Best", "Totals", "Miscellaneous", "Hero Specific" } };
                    await PagedReplyAsync(pages);
                }
                if (hero == "bastion")
                {
        ...
        public async Task GetMyOwHeroStatsQP(string hero)
        {
            try
            {
                ...
                if (hero == "baptiste")
                {
                    ...
                    string qpAssists = $"Defensive Assists: **{QpdefensiveAssists}**\nAverage Defensive Assists per 10 Minutes: **{QpdefensiveAssistsAvgPer10Min}**\nMost Defensive Assists In Game: **{QpdefensiveAssistsMostInGame}**\nHealing Done: **{QphealingDone}**\nAverage Healing Done per 10 Minutes: **{QphealingDoneAvgPer10Min}**\nMost Healing Done In Game: **{QphealingDoneMostInGame}**\nOffensive Assists: **{QpoffensiveAssists}**\nAverage Offensive Assists per 10 Minutes: **{QpoffensiveAssistsAvgPer10Min}**\nMost Offensive Assists In Game: **{QpoffensiveAssistsMostInGame}**";
                    string qpHeroSpecific = $"Amplification Matrix Assists: **{qpAmplificationMatrixAssists}**\nAverage Amplification Matrix Assists per 10 Minutes: **{qpAmplificationMatrixAssistsPer10Min}**\nMost Amplification Matrix Assists In Game: **{qpAmplificationMatrixAssistsBestIG}**\nAmplification Matrix Casts: **{qpAmplificationMatrixCasts}**\nAverage Amplification Matrix Casts per 10 Minutes: **{qpAmplificationMatrixCastsAvg10Min}**\nMost Amplification Matrix Casts In Game: **{qpAmplificationMatrixCastsMostIG}**\nDamage Amplified: **{qpDamageAmplified}**\nAverage Damage Amplified per 10 Minutes: **{qpDamageAmplifiedAvg10Min}**\nMost Damage Amplified In Game: **{qpDamageAmplifiedMostInGame}**\nHealing Accuracy: **{qpHealingAccuracy}**\nBest Healing Accuracy In Game: **{qpHealingAccuracyBestInGame}**\nHealing Amplified: **{qpHealingAmplified}**\nAverage Healing Amplified per 10 Minutes: **{qpHealingAmplifiedAvg10Min}**\nMost Healing Amplified In Game: **{qpHealingAmplifiedMostInGame}**\nImmortality Field Deaths Prevented: **{qpImmortalityFieldDeathsPrevented}**\nAverage Immortality Field Deaths Prevented per 10 Minutes: **{qpImmortalityFieldDeathsPreventedAvg10Min}**\nMost Immortality Field Deaths Prevented In Game: **{qpImmortalityFieldDeathsPreventedMostInGame}**\nSecondary Fire Accuracy: **{qpSecondaryFireAccuracy}**\nSelf Healing: **{qpSelfHealing}**\nAverage Self Healing per 10 Minutes: **{qpSelfHealingAvgPer10Min}**\nMost Self Healing In Game: **{qpSelfHealingMostInGame}**";
                    PaginatedMessage pages = new PaginatedMessage { Pages = new[] { qpAvg, qpBest, qpTotal, qpMisc, qpAssists, qpHeroSpecific }, Content = $"{config.OverwatchID}'s Hero Stats for {hero}", Color = Color.Blue, Title = new[] { "Averages", "Best", "Totals", "Miscellaneous", "Assists", "Hero Specific" } };
                    await PagedReplyAsync(pages);
                }
                if (hero == "bastion")
                {
        ...
        public async Task GetMyOwHeroStatsComp(string hero)
        {
            try
            {
                ...
                if (hero == "baptiste")
                {
                    ...
                    string compAssists = $"Defensive Assists: **{CompdefensiveAssists}**\nAverage Defensive Assists per 10 Minutes: **{CompdefensiveAssistsAvgPer10Min}**\nMost Defensive Assists In Game: **{CompdefensiveAssistsMostInGame}**\nHealing Done: **{ComphealingDone}**\nAverage Healing Done per 10 Minutes: **{ComphealingDoneAvgPer10Min}**\nMost Healing Done In Game: **{ComphealingDoneMostInGame}**\nOffensive Assists: **{CompoffensiveAssists}**\nAverage Offensive Assists per 10 Minutes: **{CompoffensiveAssistsAvgPer10Min}**\nMost Offensive Assists In Game: **{CompoffensiveAssistsMostInGame}**";
                    string compHeroSpecific = $"Amplification Matrix Assists: **{compAmplificationMatrixAssists}**\nAverage Amplification Matrix Assists per 10 Minutes: **{compAmplificationMatrixAssistsPer10Min}**\nMost Amplification Matrix Assists In Game: **{compAmplificationMatrixAssistsBestIG}**\nAmplification Matrix Casts: **{compAmplificationMatrixCasts}**\nAverage Amplification Matrix Casts per 10 Minutes: **{compAmplificationMatrixCastsAvg10Min}**\nMost Amplification Matrix Casts In Game: **{compAmplificationMatrixCastsMostIG}**\nDamage Amplified: **{compDamageAmplified}**\nAverage Damage Amplified per 10 Minutes: **{compDamageAmplifiedAvg10Min}**\nMost Damage Amplified In Game: **{compDamageAmplifiedMostInGame}**\nHealing Accuracy: **{compHealingAccuracy}**\nBest Healing Accuracy In Game: **{compHealingAccuracyBestInGame}**\nHealing Amplified: **{compHealingAmplified}**\nAverage Healing Amplified per 10 Minutes: **{compHealingAmplifiedAvg10Min}**\nMost Healing Amplified In Game: **{compHealingAmplifiedMostInGame}**\nImmortality Field Deaths Prevented: **{compImmortalityFieldDeathsPrevented}**\nAverage Immortality Field Deaths Prevented per 10 Minutes: **{compImmortalityFieldDeathsPreventedAvg10Min}**\nMost Immortality Field Deaths Prevented In Game: **{compImmortalityFieldDeathsPreventedMostInGame}**\nSecondary Fire Accuracy: **{compSecondaryFireAccuracy}**\nSelf Healing: **{compSelfHealing}**\nAverage Self Healing per 10 Minutes: **{compSelfHealingAvgPer10Min}**\nMost Self Healing In Game: **{compSelfHealingMostInGame}**";
                    PaginatedMessage pages = new PaginatedMessage { Pages = new[] { compAvg, compBest, compTotal, compMisc, compAssists, compHeroSpecific }, Content = $"{config.OverwatchID}'s Hero Stats for {hero}", Color = Color.Blue, Title = new[] { "Averages", "Best", "Totals", "Miscellaneous", "Hero Specific" } };
                    await PagedReplyAsync(pages);
                }
                if (hero == "bastion")
                {
